...
- `references/snapshot-rendering.md`: Use when writing or reviewing macOS snapshot tests. Covers `ImageRenderer` limitations with interactive controls and when to use `NSHostingView` + `NSBitmapImageRep` instead.
