...
- format the deep link as a normal clickable Markdown link whenever possible
...
- do not add extra agent-branding prose or footer text such as `Generated by Claude Code`; the Talk to the agent section, labels, and branch name are enough
