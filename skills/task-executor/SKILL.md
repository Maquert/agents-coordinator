...
16. If the implementation work is complete but the pull request is still open, keep the task in its active non-finished state and report that merge is still pending.
